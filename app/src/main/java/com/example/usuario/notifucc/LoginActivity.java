...
public class LoginActivity extends AppCompatActivity {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(iClave, password);
            mAuthTask.execute();
        }
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(int clave, String password) {
            mClave = clave;
            mPassword = password;
        }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if(db.buscarUsuario(mClave, mPassword) != null){
                usuario = db.buscarUsuario(mClave, mPassword);
                return true;
            }
